...
const SnacksBiscuits = ({ searchTerm }) => {
  ...
  useEffect(() => {
    ...
    const fetchDairyProducts = async () => {
      try {
        const response = await axios.get("http://localhost:5000/snacksBiscuits");
  ...
  return (
    <div className="ProductCard mt-4 md:mt-10">
      <h2 className="text-lg md:text-2xl font-semibold mb-4">Snacks & Biscuits</h2>
      <div className="mb-2 flex justify-end">
        <Link to="/snacks" className="text-blue-500 hover:underline">
          View All
        </Link>
      </div>
      <Swiper
