...
const SweetsDryFruits = ({ searchTerm }) => {
  ...
  return (
    ...
    <h2 className="text-lg md:text-2xl font-semibold mb-4">Sweets & Dry Fruits</h2>
    <div className="mb-2 flex justify-end">
      <Link to="/sweet" className="text-blue-500 hover:underline">
        View All
      </Link>
    </div>
    <Swiper
...
export default SweetsDryFruits;
